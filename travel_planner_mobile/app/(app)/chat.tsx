...
import { Message, UserType, TravelStyle, BudgetLevel, FilterState } from '@shared/types'
    ...
    setTimeout(() => {
      ...
      switch (nextStep) {
        case 1:
          ...
          addMessage(
            'ai',
            `Tuyệt vời! ${value} là một lựa chọn xuất sắc. Bạn định khởi hành từ đâu?`
          )
          break
        case 2:
    ...
    switch (step) {
      ...
      case 3:
        return Object.values(UserType).map((t) => (
          <TouchableOpacity key={t} onPress={() => handleNextStep(t)} style={styles.quickReply}>
